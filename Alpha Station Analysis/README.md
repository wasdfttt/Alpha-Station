...
To analyze the data, run scopedataV2.py with the file path of where the data is stored. Change the region that calculates the baseline voltage on line 71 and the integration bounds on line 98 if necessary.
